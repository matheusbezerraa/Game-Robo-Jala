...
def play():
    ...
    while playing:
        ...
        print("Qual parte eu uso para atacar o outro robô? ")
        part_to_use = input("Escolha a parte [0, 1, 2, 3, 4, 5]: ")
        part_to_use = int(part_to_use)
        
        enemy_robot.print_status()
        print("Qual parte do robô inimigo você quer atacar? ")
        part_to_attack = input("Escolha a parte [0, 1, 2, 3, 4, 5]: ")
